...
_G.packer_plugins = {
  ...
  ["ack.vim"] = {
    ...
    loaded = true,
    path = "/Users/john/.local/share/nvim/site/pack/packer/start/ack.vim",
  ...
  fzf = {
    loaded = true,
    path = "/Users/john/.local/share/nvim/site/pack/packer/start/fzf",
    url = "https://github.com/junegunn/fzf"
  },
  ["fzf.vim"] = {
    config = { 'require("plugins/fzf")' },
    loaded = true,
    path = "/Users/john/.local/share/nvim/site/pack/packer/start/fzf.vim",
    url = "https://github.com/junegunn/fzf.vim"
  },
  indentline = {
    loaded = true,
    path = "/Users/john/.local/share/nvim/site/pack/packer/start/indentline",
  ...
  ["vim-javascript"] = {
    config = { 'require("plugins/javascript")' },
    loaded = true,
    path = "/Users/john/.local/share/nvim/site/pack/packer/start/vim-javascript",
